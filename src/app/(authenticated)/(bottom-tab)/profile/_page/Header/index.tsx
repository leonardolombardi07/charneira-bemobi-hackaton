...
import LinkAnonymousUserButton from "./LinkAnonymousUserButton";
...
export default function Header({ name, email, isAnonymous }: HeaderProps) {
  return (
    <Paper>
      <Card sx={{ width: "100%" }}>
        <CardContent>
          ...
          >
            <EditableAvatar isAnonymous={isAnonymous} />
